...
[ -f /etc/vsftp/user_list ]&&{
cp /etc/vsftpd/user_list /etc/vsftpd/user_list_bak
echo "sys" >>/etc/vsftpd/user_list
echo "nuucp" >>/etc/vsftpd/user_list
echo "listen" >>/etc/vsftpd/user_list
echo "noaccess" >>/etc/vsftpd/user_list
echo "nobody4" >>/etc/vsftpd/user_list
}
